...
if uploaded_file is not None:
    ...
    st.write("""Cargando...""")
    rf_random = RandomizedSearchCV(estimator = rf, param_distributions = random_grid,scoring='neg_mean_squared_error', n_iter =     5, cv = 1, verbose=2, random_state=42, n_jobs = 1)
    st.write("""Cargando...""")
